...
const Contributions = ({ block }: IContributions) => {
  ...
  return (
    <section className='grid grid-cols-4 gap-5 sm:grid-cols-8 lg:grid-cols-12 lg:grid-rows-9 lg:h-full lg:overflow-hidden'>
      <h2 className='flex h-fit col-span-full row-start-1 row-span-1 text-scale-2 sm:col-start-1 sm:col-span-4 lg:col-span-3 lg:row-span-1'>
      ...
      <div className='flex flex-col col-span-full row-span-5 relative sm:col-start-1 sm:col-span-4 lg:col-start-5 lg:col-span-8 lg:row-span-full lg:row-start-2'>
